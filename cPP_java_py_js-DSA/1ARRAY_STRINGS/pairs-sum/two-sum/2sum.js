import {printComplexityOfSolution , printArray } from "../../../0commonFunctions/printComplexities.js"
...
function twoPairSum_Aproach_Better1(arr,target ){
    ...
    printComplexityOfSolution("Sorting + Two pointer comparison " , "O(n log n )" , "O(1)");
    let ans =[];
    arr.sort((a,b) => a-b ); 
    ...
    while (st < en ){
        ...
        else if (value > target ){ // value over shoot -> you want some smaller value -> move to left 
            en-- ; 
        }
        else{
